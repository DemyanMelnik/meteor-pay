          ...
          typeof (o = function() {
                ...
                function b(e, o, s) {
                  ...
                  if (null === e[d]) {
                    ...
                    if (!1 !== o && s instanceof Z && s.hasOwnProperty(d) && s.hasOwnProperty(g) && null !== s[d])
                      ...
                      for (let t = 0; t < i.length; ) E(e, i[t++], i[t++], i[t++], i[t++]);
                      if (0 == i.length && 0 == o) {
                        e[d] = 0;
                        try {
                          throw new Error(
            ...
            function H(e, t, o) {
              ...
              function g(t, o) {
                ...
                const P = p
                    ? function(e) {
                        if (!b.isExisting) return D(e), T.call(b.target, b.eventName, b.capture ? d : f, b.options);
                      }
                    : function(e) {
                  ...
                  I = function(t, n, r, s, a = !1, c = !1) {
                    return function() {
                      ...
                      const T = Zone.current,
                        w = x[u];
                      let E;
                      if (w) E = w[_ ? 'true' : 'false'];
                      else {
                        const e = (v ? v(u) : u) + 'false',
                          t = (v ? v(u) : u) + 'true',
                          n = i + e,
                          o = i + t;
                        (x[u] = {}), (x[u].false = n), (x[u].true = o), (E = _ ? o : n);
                      }
                      let Z,
                        S = l[E],
                        D = !1;
                      ...
                      const C = p ? R : void 0;
                      C && (C.taskData = b);
                      const I = T.scheduleEventTask(Z, h, C, r, s);
                      return (
                        (b.target = null),
                        C && (C.taskData = null),
                        y && (d.once = !0),
                        (N || 'boolean' != typeof I.options) && (I.options = d),
                        (I.target = l),
                        (I.capture = _),
                        (I.eventName = u),
            ...
            function ne(e, t) {
              ...
              if (y) {
                ...
                te(e, Q.concat(['messageerror']), r ? r.concat(t) : r, n(e)),
                  ...
                  te(HTMLMediaElement.prototype, q, r),
                  te(HTMLFrameSetElement.prototype, W.concat($), r),
                  te(HTMLBodyElement.prototype, W.concat($), r),
            ...
            Zone.__load_patch('util', (n, s, a) => {
              (a.patchOnProperties = E), (a.patchMethod = D), (a.bindArguments = g), (a.patchMacroTask = P);
                  ...
                  (n.args[0] = function() {
                    try {
                      ...
                      (t.data && t.data.isPeriodic) ||
                        ('number' == typeof n.handleId ? delete a[n.handleId] : n.handleId && (n.handleId[oe] = null));
                    }
                  }),
                      ...
                      'number' == typeof r ? (s = a[r]) : ((s = r && r[oe]), s || (s = r)),
                        s && 'string' == typeof s.type
                          ? 'notScheduled' !== s.state &&
                            ...
                            ('number' == typeof r ? delete a[r] : r && (r[oe] = null), s.zone.cancelTask(s))
                          : t.apply(e, o);
                    }
                ));
            }
                      ...
                      () =>
                        function(e, o) {
                          ...
                          if (r && 'string' == typeof r.type) {
                            ...
                            r.zone.cancelTask(r);
                          } else if (!0 === t.current[v]) return w.apply(e, o);
                        }
                    );
                })(e);
                const n = u('xhrTask'),
